...
if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2022\Preview\MSBuild\Current\Bin\MSBuild.exe" (
    set MSBUILD="%ProgramFiles(x86)%\Microsoft Visual Studio\2022\Preview\MSBuild\Current\Bin\MSBuild.exe"
    goto :FOUND_MSBUILD
)
